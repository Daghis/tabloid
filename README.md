...
Tabloid supports comments! Use `SOURCES SAY` ... `THAT'S THE RUMOR` for block comments.
...
Tabloid now has comments! Use `SOURCES SAY` ... `THAT'S THE RUMOR` for multi-line block comments.
